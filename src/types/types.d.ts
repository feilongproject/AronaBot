...
declare global {
        ...
        type GUILD_MESSAGE_REACTIONS__body = {
            ...
            target: {
                ...
                type:
                    ...
                    | 'ReactionTargetType_FEED'
                    | 'ReactionTargetType_COMMNENT';
            };
            user_id: string;
        };
    ...
    /** 运行时枚举见 src/constants/IntentEventType.ts（tsx 不支持 .d.ts ambient const enum） */
    type IntentEventType = import('../constants/IntentEventType').IntentEventType;
